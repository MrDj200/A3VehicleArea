...
if(!canSuspend)	exitWith {["Please use '[] spawn Dj_fnc_loadArea' to execute this!","hint",true,true] call BIS_fnc_MP;};
...
if (isServer) then
{
	...
	_saveArray = profileNamespace getVariable [_saveString, []];
	...
	["Loading done!","hint",true,true] call BIS_fnc_MP;
